<form name="myForm" action="index.php?controller=Citizen&action=onClickSubmitForm" method="post">
    ...
    <div class="question">
        ...
        <textarea id="w3review" name="field-1" rows="2" cols="60"></textarea>

        <div>License Plate:</div>
        <textarea id="w3review" name="field-2" rows="2" cols="60"></textarea>

        <div>Seat Number:</div>
        <textarea id="w3review" name="field-3" rows="2" cols="60"></textarea>
        ...
        <textarea id="w3review" name="field-6" rows="2" cols="60"></textarea>

        <div>Destination Country</div>
        <textarea id="w3review" name="field-7" rows="2" cols="60"></textarea>

        <div>Source Address</div>
        <textarea id="w3review" name="field-8" rows="2" cols="60"></textarea>

        <div>Destination Address</div>
        <textarea id="w3review" name="field-9" rows="2" cols="60"></textarea>

        <div>During the past 14 days, which countries/territories did you visit?</div>
        <textarea id="w3review" name="field-10" rows="2" cols="60"></textarea>
